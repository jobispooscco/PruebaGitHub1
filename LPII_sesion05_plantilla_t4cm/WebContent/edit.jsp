		...
		<form action="crudprod" method="post">
			...
			<div class="form-group">
				<label for="exampleInputEmail1">Nombre del producto:</label> <input
					...
					placeholder="Nombre del producto" name="txtNombre" value="${data.descripcion}">

			</div>

			<div class="form-group">
				<label for="exampleInputEmail1">Stock :</label> <input type="number"
					class="form-control" id="apellido" placeholder="0" name="txtStock" value="${data.stock}">
			...
			<div class="form-group">
				<label for="exampleInputEmail1">Precio :</label> <input
					...
					placeholder="0.00" name="txtUsuario" value="${data.precio}">
			...
			<button type="submit" class="btn btn-info"    name="btns" value="q">Actualizar</button>
